...
//void prepareStartServerStructure()
//{
//	static const TCHAR * START_SERVER_SCRIPT = TEXT("/C start.bat");
//	static const TCHAR * START_SERVER_SCRIPT_DIRECTORY = TEXT("ka-lite\\");
//
...
//	startServerShellExecuteInfo.lpParameters = START_SERVER_SCRIPT;
//	startServerShellExecuteInfo.lpDirectory = START_SERVER_SCRIPT_DIRECTORY;
...
//void prepareStopServerStructure()
//{
//	static const TCHAR * STOP_SERVER_SCRIPT = TEXT("/C stop.bat");
//	static const TCHAR * STOP_SERVER_SCRIPT_DIRECTORY = TEXT("ka-lite\\");
//
...
//	stopServerShellExecuteInfo.lpParameters = STOP_SERVER_SCRIPT;
//	stopServerShellExecuteInfo.lpDirectory = STOP_SERVER_SCRIPT_DIRECTORY;
...
//		if(op==0)
//		{
//			sendTrayMessage("KA Lite has successfully stopped", "You may now close the aplication or restart the server.");
//		}
//	}
//	else
//	{
...
//				SERVERISONLINE = TRUE;
//				NEEDTOCHECK = FALSE;
//				sendTrayMessage("KA Lite is running", "The server will be accessible locally at: http://127.0.0.1:8008/ or you can press \"Open KA Lite button\"");
//			}
//		}
//	}
//
...
//
//			HMENU hConfigurationSubMenu = CreateMenu();
//			AppendMenu(hConfigurationSubMenu, MF_STRING, 123456789, L"Run KA Lite when the user log");
//			AppendMenu(hConfigurationSubMenu, MF_STRING, 12345678910, L"Run KA Lite at system startup");
//			AppendMenu(hConfigurationSubMenu, MF_STRING, 12345678911, L"Minimize to tray when KA Lite is run");
//			AppendMenu(hConfigurationSubMenu, MF_STRING, 12345678912, L"Auto-start server when KA Lite is run");
//
//			CheckMenuItem(hConfigurationSubMenu, 123456789, MF_CHECKED);
//			EnableMenuItem(hConfigurationSubMenu, 12345678910, TRAY_DISABLED);
//
//			AppendMenu(hMenu, MF_STRING| MF_POPUP, (UINT)hConfigurationSubMenu, L"Configuration");
//
//			AppendMenu(hMenu, MF_STRING, ID_TRAY_EXIT_CONTEXT_MENU_ITEM, L"Exit KA Lite");
//
//			/*
...
//*/
//int WINAPI WinMainn(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow){
//	
...
//
//	TrayMenuItem *mi1 = new TrayMenuItem();
//	mi1->x = 10;
//	mi1->action = &teste1;
//	//mi1->action();
//
//	TrayMenuItem *mi2 = new TrayMenuItem();
//	mi2->x = 20;
//	mi2->action = &teste2;
//	//mi2->action();
//
//	map<int, TrayMenuItem*> mymap;
//	mymap.insert(pair<int,TrayMenuItem*>(0, mi1));
//	mymap.insert(pair<int,TrayMenuItem*>(1, mi2));
//
//	int i = 0;
//	for(i=0;i<2; i++) 
//	{
//		(( mymap.find(i) )->second)->action();
//		Sleep(10000);
//	}
//
//	/*
...
{
	printConsole(L"I am starting server.\n");

	if(!runShellScript(L"lol.bat", L"MIRRR", L"ka-lite\\"))
	{
		printConsole(L"ERRO A INICIAR.\n");
	}
}

void trayMenuAction2()
{
	printConsole(L"I am stoping server\n");
}
...
void statusFunction()
{
	//printConsole(L"I am processing window status KA Lite.\n");
}

int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	fle_TrayWindow * window = new fle_TrayWindow(&hInstance);
	window->setTrayIcon(L"images\\logo48.ico");
	window->setStatusFunction(&statusFunction);

	fle_TrayMenuItem * menu1 = new fle_TrayMenuItem(L"Start Server", &trayMenuAction1);
	fle_TrayMenuItem * menu2 = new fle_TrayMenuItem(L"Stop Server", &trayMenuAction2);
	fle_TrayMenuItem * menu3 = new fle_TrayMenuItem(L"Options", NULL);
	fle_TrayMenuItem * menu4 = new fle_TrayMenuItem(L"Option 1", &trayMenuAction3);
	fle_TrayMenuItem * menu5 = new fle_TrayMenuItem(L"Exit KA Lite", &trayMenuAction4);
